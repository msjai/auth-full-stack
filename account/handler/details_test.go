...
import (
	...
	"github.com/msjai/auth-full-stack/account/model/mocks"
...
func TestDetails(t *testing.T) {
	...
	t.Run("Update success", func(t *testing.T) {
		...
		newName := "msjai"
		newEmail := "msjai@msjai.com"
		newWebsite := "https://msjai.me"
		...
		dbImageURL := "https://msjai.me/static/696292a38f493a4283d1a308e4a11732/84d81/Profile.jpg"
